...
public class UsuarioMapperImpl implements UsuarioMapper {
    ...
    public UsuarioDTO toDTO(Usuario entity) {
        ...
        usuarioDTO.setIdEspecialidad( entity.getIdEspecialidad() );
        usuarioDTO.setIdInstitucion( entity.getIdInstitucion() );
        usuarioDTO.setIdTipo( entity.getIdTipo() );
    ...
    public Usuario fromDTO(UsuarioDTO entity) {
        ...
        usuario.setIdEspecialidad( entity.getIdEspecialidad() );
        usuario.setIdInstitucion( entity.getIdInstitucion() );
        usuario.setIdTipo( entity.getIdTipo() );
